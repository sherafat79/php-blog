              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover">
                  ...
                  <?php
                    ...
                    $result = $connect->query("SELECT * FROM `tbl_news` ORDER BY `id` DESC ");
                    ...
                    while ($rows = mysqli_fetch_assoc($result)) {
                        ...
                        <td>{$rows['date']}</td>
                            <td class='d-flex gap-2'>
                                <a class='btn  btn-danger' href='check/del_news.php?id={$rows['id']}'>حذف</a>
                                <a class='btn mr-3  btn-warning' href='newsedit.php?id={$rows['id']}'>ویرایش</a>
                            </td>
                        </tr>";
                    }
                    ?>

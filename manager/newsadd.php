  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">ایجاد خبر</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
	...
	$template->isParametr("typeerror","پسوند فایل مورد نظر شما صحیح نمی باشد","danger");
	 ?>
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form"   action="check/add_news.php" method="post" name="frmnewsadd" enctype="multipart/form-data" >
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1">عنوان خبر</label>
                    <input name="title" class="form-control" id="exampleInputEmail1" placeholder="عنوان را وارد کنید"/>
                  
                  </div>
                  <div class="form-group">
                    <label>متن کوتاه</label>
                    <textarea name="short" class="form-control" rows="3" placeholder="بنویسید..."></textarea>
                  </div>
                  <input type="hidden" name="send">
                  <div class="form-group">
                    <label>متن خبر</label>
                    <textarea name="long" class="form-control" rows="3" placeholder="بنویسید..."></textarea>
                  </div>
                  <div class="form-group">
